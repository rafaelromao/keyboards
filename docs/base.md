...
## Layout Overview
- This is split keyboard layout that goes from 24 to 34 keys, from the formats 13332+2 to 3x5+2. Most of the time I use boards in the 23332+2 format, like the Rommana and Hummingbird, but with the 1333+2 keymap.
