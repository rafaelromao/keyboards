...
- Romak is the layout used in the default base layer. It is inspired in [Colemak](https://colemak.org) and [BEAKL](https://ieants.cc/beakl), improved to remove load from pinkies and for typing in Portuguese.
