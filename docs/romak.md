...
- Romak is the layout used in the default base layer. It is inspired in Colemak and BEAKL, improved to remove load from pinkies and for typing in Portuguese.
