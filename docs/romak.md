...
![img](https://i.imgur.com/PKLz136.png)

- Romak is the layout used in the default base layer. It is a Colemak-DH variant, improved to remove load from pinkies and for prose in Portuguese.
- Romak has a higher SFB rate than Colemak-DH, close to Workman, but most of this load goes to the stronger fingers.
...
![img](https://i.imgur.com/x4ptxc0.png)
...
![img](https://i.imgur.com/t6Nwwys.png)
#### English
...
![img](https://i.imgur.com/ktjZol9.png)

### Detailed Finger Analysis
The [Colemak mod-DH analysis tool](https://colemakmods.github.io/mod-dh/analyze.html) was also used to compare the Romak against Colemak-DH and Workman.
<p float="left">
  <img src="https://i.imgur.com/3jkdMKK.png" width="450" />
