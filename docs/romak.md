...
- The [Numpad](symbols.md#numpad-layer) gives access to functions keys and numbers, in the same layer, can is toogled on/off, instead of temporarily activated.
