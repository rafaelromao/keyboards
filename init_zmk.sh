...
build_cygnus_central_dongle="west build -s app -b nice_nano_v2 --build-dir build/cygnus_central_dongle -- -DSHIELD='cygnus_central_dongle dongle_display' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/boards/handwired -DZMK_EXTRA_MODULES=$DONGLE_HOME"
build_cygnus_central_left="west build -s app -b nice_nano_v2 --build-dir build/cygnus_central_left -- -DSHIELD='cygnus_central_left' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/boards/handwired"
build_cygnus_peripheral_left="west build -s app -b nice_nano_v2 --build-dir build/cygnus_peripheral_left -- -DSHIELD='cygnus_peripheral_left' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/boards/handwired"
build_cygnus_peripheral_right="west build -s app -b nice_nano_v2 --build-dir build/cygnus_peripheral_right -- -DSHIELD='cygnus_peripheral_right' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/boards/handwired"
...
build_diamond_central_dongle="west build -s app -b nice_nano_v2 --build-dir build/diamond_central_dongle -- -DSHIELD='diamond_central_dongle dongle_display' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/boards/handwired -DZMK_EXTRA_MODULES=$DONGLE_HOME"
build_diamond_central_left="west build -s app -b nice_nano_v2 --build-dir build/diamond_central_left -- -DSHIELD='diamond_central_left' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/boards/handwired"
build_diamond_peripheral_left="west build -s app -b nice_nano_v2 --build-dir build/diamond_peripheral_left -- -DSHIELD='diamond_peripheral_left' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/boards/handwired"
build_diamond_peripheral_right="west build -s app -b nice_nano_v2 --build-dir build/diamond_peripheral_right -- -DSHIELD='diamond_peripheral_right' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/boards/handwired"
