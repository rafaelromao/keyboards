...
alias build_diamond="cd ${ZMK_HOME} && ${build_diamond_central_dongle} && ${archive_diamond_central_dongle} && ${build_diamond_central_dongle} && ${archive_diamond_central_dongle} && cd $KEYBOARD_HOME"
