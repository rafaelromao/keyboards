...
echo "Creating Choc Diamond build alias..."
build_choc_diamond_central_dongle="west build -s app -b nice_nano_v2 --build-dir build/choc_diamond_central_dongle -- -DSHIELD='choc_diamond_central_dongle dongle_display' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/keyboards/choc_diamond -DZMK_EXTRA_MODULES='$DONGLE_DISPLAY_HOME;$BEHAVIOR_MODULES'"
build_choc_diamond_central_left="west build -s app -b nice_nano_v2 --build-dir build/choc_diamond_central_left -- -DSHIELD='choc_diamond_central_left' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/keyboards/choc_diamond -DZMK_EXTRA_MODULES='$BEHAVIOR_MODULES'"
build_choc_diamond_peripheral_left="west build -s app -b nice_nano_v2 --build-dir build/choc_diamond_peripheral_left -- -DSHIELD='choc_diamond_peripheral_left' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/keyboards/choc_diamond -DZMK_EXTRA_MODULES='$BEHAVIOR_MODULES'"
build_choc_diamond_peripheral_right="west build -s app -b nice_nano_v2 --build-dir build/choc_diamond_peripheral_right -- -DSHIELD='choc_diamond_peripheral_right' -DZMK_CONFIG=$KEYBOARD_HOME/src/zmk/keyboards/choc_diamond -DZMK_EXTRA_MODULES='$BEHAVIOR_MODULES'"
archive_choc_diamond_central_dongle="mkdir -p $KEYBOARD_HOME/build/artifacts; [ -f build/choc_diamond_central_dongle/zephyr/zmk.uf2 ] && mv -f build/choc_diamond_central_dongle/zephyr/zmk.uf2 $KEYBOARD_HOME/build/artifacts/choc_diamond_central_dongle-zmk.uf2"
archive_choc_diamond_central_left="mkdir -p $KEYBOARD_HOME/build/artifacts; [ -f build/choc_diamond_central_left/zephyr/zmk.uf2 ] && mv -f build/choc_diamond_central_left/zephyr/zmk.uf2 $KEYBOARD_HOME/build/artifacts/choc_diamond_central_left-zmk.uf2"
archive_choc_diamond_peripheral_left="mkdir -p $KEYBOARD_HOME/build/artifacts; [ -f build/choc_diamond_peripheral_left/zephyr/zmk.uf2 ] && mv -f build/choc_diamond_peripheral_left/zephyr/zmk.uf2 $KEYBOARD_HOME/build/artifacts/choc_diamond_peripheral_left-zmk.uf2"
archive_choc_diamond_peripheral_right="mkdir -p $KEYBOARD_HOME/build/artifacts; [ -f build/choc_diamond_peripheral_right/zephyr/zmk.uf2 ] && mv -f build/choc_diamond_peripheral_right/zephyr/zmk.uf2 $KEYBOARD_HOME/build/artifacts/choc_diamond_peripheral_right-zmk.uf2"
alias build_choc_diamond_all="${checkout_main_zmk} && cd ${ZMK_HOME} && ${build_choc_diamond_central_left} && ${archive_choc_diamond_central_left} && ${build_choc_diamond_central_dongle} && ${archive_choc_diamond_central_dongle} && ${build_choc_diamond_peripheral_left} && ${archive_choc_diamond_peripheral_left} && ${build_choc_diamond_peripheral_right} && ${archive_choc_diamond_peripheral_right} && cd ${KEYBOARD_HOME}"
