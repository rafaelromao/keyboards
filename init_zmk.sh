...
cd $ZMK_HOME
git fetch
git checkout 20231007/rafaelromao/main
git pull
cd ..
...
alias build_zen_both_sides="cd zmk && ${build_zen_left} && ${archive_zen_left} && ${build_zen_right} && ${archive_zen_right} && cd .."
alias build_zen="cd zmk && ${build_zen_left} && ${archive_zen_left} && cd .."
