...
./scripts/draw-image.sh keymap-drawer-noseparatecombos.yaml vim alpha1 vim
...
./scripts/draw-image.sh keymap-drawer-noseparatecombos.yaml 3d-design-mehs 3d-design-meh 3d-design-hyper
