...
TBKMINI="keyboards/bastardkb/tbkmini/keymaps"
...
if [[ ! -d "$QMK_HOME/$TBKMINI/rafaelromao" ]]
then
    echo "Creating TBK MINI symbolic link..."
    ln -s "$KEYBOARD_HOME/src/qmk/$TBKMINI/rafaelromao" "$QMK_HOME/$TBKMINI"
fi
