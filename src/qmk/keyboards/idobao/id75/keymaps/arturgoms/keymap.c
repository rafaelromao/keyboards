...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 // |____________________________________________________________________________________________________________________________________________________________________|
      KC_GESC, _________________LAYOUT_L0________________, XXXXXXX,XXXXXXX,XXXXXXX,  ________________LAYOUT_R0________________, KC_BSPC, 
 // |----------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      KC_TAB     ,_________________LAYOUT_L1________________ ,XXXXXXX,XXXXXXX,XXXXXXX , ________________LAYOUT_R1________________ , KC_DEL,
 // |----------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      KC_ESC    ,_________________LAYOUT_L2________________ ,XXXXXXX,XXXXXXX,XXXXXXX, ________________LAYOUT_R2________________ , KC_ENT,
 // |----------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      KC_LSFT  ,_________________LAYOUT_L3________________ ,XXXXXXX,XXXXXXX,XXXXXXX, ________________LAYOUT_R3________________ , KC_RSFT,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      KC_LCTL , XXXXXXX ,     KC_LALT   , ____LAYOUT_L4_____   ,XXXXXXX,RGB_MOD,XXXXXXX, ______LAYOUT_R4______ , KC_RALT , XXXXXXX , KC_RCTL),
