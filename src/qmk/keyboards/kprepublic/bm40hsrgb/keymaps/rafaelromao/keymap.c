...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 // |_______________________________________________________________________________________________________________________|
      KC_QUOT , _________ROMAK_L1__________ , KC_Z    , XXXXXXX , XXXXXXX , KC_X    , _________ROMAK_R1__________ , MC_SQ_C  ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+----------|
      ___________________ROMAK_L2____________________ , XXXXXXX , XXXXXXX , ___________________ROMAK_R2____________________  ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+----------|
      KC_Q    , _________ROMAK_L3____________________ , XXXXXXX , XXXXXXX , ___________________ROMAK_R3__________ , KC_Y     ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
