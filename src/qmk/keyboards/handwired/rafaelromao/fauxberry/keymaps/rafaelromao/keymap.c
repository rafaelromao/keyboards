...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      SHO_KCD , ________ALPHA1_L3____________________ , __________________ALPHA1_R3__________ , SHO_KCI ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      NAV_AT  , _________LOWER_L3____________________ , ___________________LOWER_R3__________ , KC_DOT ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      XXXXXXX , _________RAISE_L3____________________ , ___________________RAISE_R3__________ , COD_AST ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      XXXXXXX , _________NUMPAD_L3___________________ , ___________________NUMPAD_R3_________ , SHO_DOT ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      MO_SYS  , ______SHORTCUTS_L3___________________ , ________________SHORTCUTS_R3_________ , MO_SYS  ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      MC_PROJ , _________CODING_L3___________________ , ___________________CODING_R3_________ , XXXXXXX ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      KC_D    , _________NOMOD_L3____________________ , ___________________NOMOD_R3__________ , KC_I    ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      KC_Y    , _________ALPHA2_L3___________________ , ___________________ALPHA2_R3_________ , MC_SQ_I ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      KC_AT   , _______SYMBOLS_L3____________________ , _________________SYMBOLS_R3__________ , KC_ASTR ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      XXXXXXX , _________NAVIGATION_L3_______________ , ___________________NAVIGATION_R3_____ , KC_RGHT ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      XXXXXXX , _________MEDIA_L3____________________ , ___________________MEDIA_R3__________ , MC_CAM  ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
 ...
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      XXXXXXX , _________NAVIGATION_L3_______________ , ___________________NAVIGATION_R3_____ , KC_RGHT ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
                          __FIXED_NAV__L4__ , XXXXXXX , XXXXXXX , __FIXED_NAV__R4__),
 // |___________________________________________________________________________________________________|
