...
const uint16_t PROGMEM l_ng_i_combo[]    = {MC_SQUO, MC_WH, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(l_ng_the_combo, MC_THE),   COMBO(l_ng_i_combo, MC_I),          COMBO(l_ng_ion_combo, MC_ION),
    ...
    COMBO(r_rom_low_combo, MO_LOW),  COMBO(r_rom_ent_combo, KC_ENT),     COMBO(r_rom_ful_combo, MC_FULL),
