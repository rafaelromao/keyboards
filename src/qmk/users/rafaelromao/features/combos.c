...
combo_t key_combos[] = {
    ...
    COMBO(r_rom_sent_combo, MC_SENT), COMBO(r_rom_spa_combo, MC_SPAS),  COMBO(r_rom_tab_combo, KC_TAB),
    COMBO(r_acc_tab_combo, KC_TAB),   COMBO(r_rom_zj_combo, TD_ZJ),     COMBO(r_rom_x_combo, KC_X),
