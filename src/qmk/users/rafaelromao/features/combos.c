...
const uint16_t PROGMEM l_rom_q_combo[]   = {KC_F, KC_D, COMBO_END};
const uint16_t PROGMEM l_rom_z_combo[]   = {KC_C, LALTT_P, COMBO_END};
const uint16_t PROGMEM l_rom_y_combo[]   = {LCTLT_S, LGUIT_T, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    COMBO(l_rom_q_combo, KC_Q),      COMBO(l_rom_y_combo, KC_Y),      COMBO(l_rom_z_combo, KC_Z),
