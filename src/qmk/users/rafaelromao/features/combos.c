...
combo_t key_combos[] = {
    COMBO(l_low_sqo_combo, MC_SQUO),  COMBO(l_low_bti_combo, MC_BTIC),  COMBO(r_low_sfg_combo, LSFT(KC_L)),
    COMBO(l_low_bsl_combo, KC_BSLS),  COMBO(r_low_sent_combo, MC_SENT), COMBO(r_low_j_combo, KC_A),
    ...
    COMBO(l_sym_grv_combo, KC_GRV),   COMBO(l_sym_eur_combo, MC_EUR),   COMBO(r_sym_perc_combo, KC_PERC),
    COMBO(r_sym_cir_combo, KC_CIRC),  COMBO(r_sym_amp_combo, KC_AMPR),  COMBO(r_sym_pip_combo, KC_PIPE),
    COMBO(r_sym_til_combo, KC_TILD),  COMBO(r_sym_bsp_combo, KC_BSPC),  COMBO(r_low_com_combo, KC_COMM),
    COMBO(r_num_com_combo, KC_COMM),  COMBO(l_acc_esc_combo, MC_ESCC),  COMBO(l_acc_und_combo, KC_UNDS),
    COMBO(l_acc_ques_combo, MC_QUES), COMBO(l_acc_dqo_combo, MC_DQUO),  COMBO(l_low_cur_combo, MC_CUR),
    COMBO(l_low_bra_combo, MC_BRAC),  COMBO(l_low_par_combo, TD_PARN),  COMBO(l_nav_esc_combo, MC_ESCC),
    COMBO(l_num_esc_combo, MC_ESCC),  COMBO(l_num_ent_combo, KC_ENT),   COMBO(l_num_num_combo, TO_A1),
    ...
    COMBO(r_nav_pas_combo, MC_PAST),  COMBO(r_low_bsp_combo, KC_BSPC),  COMBO(r_nav_bsp_combo, KC_BSPC),
    COMBO(l_num_tab_combo, KC_TAB),   COMBO(l_num_del_combo, KC_DEL),   COMBO(r_low_tab_combo, KC_TAB),
    ...
    COMBO(r_rom_bsp_combo, KC_BSPC),  COMBO(r_rom_d_combo, KC_D),       COMBO(r_rom_p_combo, KC_P),
    COMBO(l_rom_ent_combo, KC_ENT),   COMBO(r_rom_ent_combo, KC_ENT),   COMBO(r_rom_j_combo, HYP_KCJ),
    COMBO(r_rom_cop_combo, MC_COPY),  COMBO(r_rom_pas_combo, MC_PAST),  COMBO(r_rom_sal_combo, MC_SELC),
    COMBO(r_rom_scp_combo, MC_SCOP),  COMBO(r_rom_spa_combo, MC_SPAS),  COMBO(r_low_cop_combo, MC_COPY),
    COMBO(r_low_pas_combo, MC_PAST),  COMBO(r_low_sal_combo, MC_SELC),  COMBO(r_low_scp_combo, MC_SCOP),
    COMBO(r_low_spa_combo, MC_SPAS),  COMBO(r_rom_sco_combo, TD_SCLE),  COMBO(r_rom_sent_combo, MC_SENT),
