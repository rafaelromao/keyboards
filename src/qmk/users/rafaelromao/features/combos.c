...
combo_t key_combos[] = {
    ...
    COMBO(r_low_tab_combo, KC_TAB),    COMBO(r_rai_bsp_combo, KC_BSPC),  COMBO(r_rai_deq_combo, MC_DEQ),
    ...
    COMBO(r_low_scp_combo, MC_SCOP),   COMBO(r_low_spa_combo, MC_SPAS),  COMBO(r_rom_sco_combo, TD_SCLE),
    COMBO(r_rom_sent_combo, MC_SENT),  COMBO(l_rom_tab_combo, KC_TAB),   COMBO(r_rom_tab_combo, KC_TAB),
    ...
    COMBO(r_rom_y_combo, KC_Y),        COMBO(r_sho_bsp_combo, KC_BSPC),  COMBO(l_cod_esc_combo, MC_ESCC),
