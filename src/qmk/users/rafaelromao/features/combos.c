...
const uint16_t PROGMEM l_num_f13_combo[] = {AL_F3, KC_F2, COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(r_rom_spa_combo, MC_SPAS),   COMBO(l_low_cur_combo, MC_CUR),   COMBO(r_acc_eur_combo, MC_EUR),
    COMBO(l_low_par_combo, TD_PARN),
    ...
    COMBO(l_num_f14_combo, KC_F14),    COMBO(l_num_f13_combo, KC_F13),   COMBO(l_num_sav_combo, MC_SAVE),
    ...
    COMBO(r_sho_z0r_combo, MC_Z0R),    COMBO(r_med_ent_combo, TD_EENT),  COMBO(r_nav_bsp_combo, KC_BSPC),
    COMBO(r_nav_ent_combo, KC_ENT),    COMBO(r_nav_cop_combo, MC_COPY),  COMBO(r_nav_pas_combo, MC_PAST),
    COMBO(r_num_bsp_combo, KC_BSPC),   COMBO(r_num_ent_combo, KC_ENT),   COMBO(r_num_npd_combo, TG_NUM),
    COMBO(r_num_tab_combo, KC_TAB),    COMBO(r_rai_bsp_combo, KC_BSPC),  COMBO(l_rai_f10_combo, KC_F10),
    COMBO(l_rai_f11_combo, KC_F11),    COMBO(l_rai_f12_combo, KC_F12),   COMBO(l_rai_f13_combo, KC_F13),
    COMBO(l_rai_f14_combo, KC_F14),    COMBO(l_rai_f15_combo, KC_F15),   COMBO(r_rai_deq_combo, MC_DEQ),
    COMBO(r_rai_gt_combo, TD_GT),      COMBO(r_rai_lt_combo, TD_LT),     COMBO(r_rai_ltgt_combo, MC_LTGT),
    COMBO(r_rai_neq_combo, MC_NEQ),    COMBO(r_rai_sar_combo, TD_SARR),  COMBO(r_rom_bsp_combo, KC_BSPC),
    COMBO(r_rom_cop_combo, MC_COPY),   COMBO(r_rom_d_combo, KC_D),       COMBO(r_rom_ent_combo, KC_ENT),
    COMBO(r_rom_npd_combo, TG_NUM),    COMBO(r_rom_p_combo, KC_P),       COMBO(r_rom_pas_combo, MC_PAST),
    COMBO(r_rom_sal_combo, MC_SELC),   COMBO(r_rom_sco_combo, TD_SCLE),  COMBO(r_rom_tab_combo, KC_TAB),
    COMBO(r_rom_v_combo, KC_V),        COMBO(r_rom_x_combo, KC_X),       COMBO(r_rom_y_combo, KC_Y),
