...
const uint16_t PROGMEM l_acc_lpa_combo[]  = {KC_Z, KC_X, KC_W, COMBO_END};
const uint16_t PROGMEM l_acc_rpa_combo[]  = {KC_J, MC_SQ_C, KC_V, COMBO_END};
const uint16_t PROGMEM l_acc_ja_combo[]   = {KC_J, MC_SQ_C, COMBO_END};
const uint16_t PROGMEM l_acc_squo_combo[] = {MC_QU, KC_K, COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(r_low_com_combo, KC_COMM),  COMBO(r_num_com_combo, KC_COMM),  COMBO(l_acc_dquo_combo, MC_DQUO),
    COMBO(l_acc_esc_combo, MC_ESCC),  COMBO(l_acc_ja_combo, MC_JA),     COMBO(l_acc_lpa_combo, KC_LPRN),
    COMBO(l_acc_rpa_combo, KC_RPRN),  COMBO(l_acc_lh_combo, MC_LH),     COMBO(l_acc_ques_combo, MC_QUES),
    COMBO(l_acc_squo_combo, MC_SQUO), COMBO(l_low_cur_combo, MC_CUR),   COMBO(l_low_bra_combo, MC_BRAC),
    COMBO(l_low_par_combo, TD_PARN),  COMBO(l_nav_esc_combo, MC_ESCC),  COMBO(l_num_esc_combo, MC_ESCC),
    COMBO(l_num_f10_combo, KC_F10),   COMBO(l_num_f11_combo, KC_F11),   COMBO(l_num_num_combo, TO_A1),
    ...
    COMBO(l_rai_f15_combo, KC_F15),   COMBO(l_rom_cap_combo, TG_CAPS),  COMBO(l_rom_esc_combo, MC_ESCC),
    COMBO(l_rom_esv_combo, MC_ESAV),  COMBO(l_rom_fin_combo, MC_FIND),  COMBO(l_rom_ful_combo, MC_FULL),
    COMBO(l_rom_j_combo, KC_J),       COMBO(l_rom_k_combo, KC_K),       COMBO(l_rom_num_combo, TG_NUMC),
    COMBO(l_rom_q_combo, KC_Q),       COMBO(l_rom_sav_combo, MC_SAVE),  COMBO(l_rom_und_combo, MC_UNDO),
    COMBO(l_rom_usc_combo, KC_UNDS),  COMBO(l_rom_v_combo, KC_V),       COMBO(l_rom_w_combo, KC_W),
    COMBO(l_rom_z_combo, KC_Z),       COMBO(l_sho_bui_combo, MC_BUID),  COMBO(l_sho_ref_combo, MC_REFC),
    COMBO(r_acc_ao_combo, MC_AO),     COMBO(r_acc_bsp_combo, KC_BSPC),  COMBO(r_acc_cao_combo, MC_CAO),
    COMBO(r_acc_coes_combo, MC_COES), COMBO(r_acc_col_combo, KC_COLN),  COMBO(r_acc_eur_combo, MC_EUR),
    ...
    COMBO(r_nav_bsp_combo, KC_BSPC),  COMBO(r_nav_cop_combo, MC_COPY),  COMBO(r_nav_ent_combo, KC_ENT),
