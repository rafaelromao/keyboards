...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(l_rom_pas_combo, MC_PAST), COMBO(l_rom_esc_combo, KC_ESC),     COMBO(r_rom_und_combo, MC_UNDO),
    COMBO(r_rom_sce_combo, MC_SENT), COMBO(l_rom_fin_combo, MC_FIND),    COMBO(l_rom_cop_combo, MC_COPY),
    COMBO(r_rom_tab_combo, KC_TAB),  COMBO(r_rom_oes_combo, MC_OESC),    COMBO(r_rom_low_combo, OS_LOW),
    COMBO(r_rom_rai_combo, OS_RAI),  COMBO(r_rom_ent_combo, KC_ENT),     COMBO(r_rom_sal_combo, MC_SELC),
    COMBO(r_med_hom_combo, KC_HOME), COMBO(r_med_end_combo, KC_END),     COMBO(r_rai_cur_combo, MC_CUR),
    COMBO(r_med_del_combo, KC_DEL),  COMBO(r_med_ins_combo, KC_INS),     COMBO(r_med_ent_combo, TD_EENT),
