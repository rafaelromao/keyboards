...
combo_t key_combos[] = {
    ...
    COMBO(r_num_ent_combo, KC_ENT),    COMBO(r_acc_ja_combo, MC_JA),     COMBO(r_acc_squo_combo, MC_SQUO),
    COMBO(l_low_cur_combo, MC_CUR),    COMBO(l_low_par_combo, TD_PARN),  COMBO(l_low_par_combo, MC_BRAC),
    COMBO(r_low_ent_combo, KC_ENT),    COMBO(r_acc_ao_combo, MC_AO),     COMBO(r_acc_cao_combo, MC_CAO),
    ...
    COMBO(r_rom_sco_combo, TD_SCLE),   COMBO(r_rom_sent_combo, MC_SENT), COMBO(l_rom_num_combo, TG_NUMC),
    COMBO(l_num_num_combo, MC_ESCC),   COMBO(r_low_sco_combo, TD_SCLE),  COMBO(l_rom_usc_combo, KC_UNDS),
    COMBO(l_rom_ful_combo, MC_FULL),   COMBO(r_rom_pas_combo, MC_PAST),  COMBO(r_rom_spa_combo, MC_SPAS),
    COMBO(l_rom_sav_combo, MC_SAVE),   COMBO(l_rom_esc_combo, MC_ESCC),  COMBO(l_rom_und_combo, MC_UNDO),
    COMBO(l_rom_fin_combo, MC_FIND),   COMBO(r_rom_bsp_combo, KC_BSPC),  COMBO(r_rom_tab_combo, KC_TAB),
    ...
    COMBO(r_rai_lt_combo, TD_LT),      COMBO(r_rai_gt_combo, TD_GT),     COMBO(r_med_ent_combo, TD_EENT),
