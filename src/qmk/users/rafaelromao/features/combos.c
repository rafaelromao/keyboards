...
combo_t key_combos[] = {
    ...
    COMBO(l_low_par_combo, TD_PARN),   COMBO(r_low_ent_combo, KC_ENT),   COMBO(r_acc_ae_combo, MC_AE),
    ...
    COMBO(l_rom_num_combo, TG_NUMC),   COMBO(r_low_sco_combo, TD_SCLE),  COMBO(l_rom_usc_combo, KC_UNDS),
    COMBO(l_rom_ful_combo, MC_FULL),   COMBO(r_rom_sent_combo, MC_SENT),
#ifndef SAVE_MEMORY
    ...
    COMBO(r_rom_bsp_combo, KC_BSPC),   COMBO(r_rom_tab_combo, KC_TAB),   COMBO(r_rom_ent_combo, KC_ENT),
    ...
    COMBO(r_rai_gt_combo, TD_GT),      COMBO(l_low_cur_combo, MC_CUR),   COMBO(r_med_ent_combo, TD_EENT),
