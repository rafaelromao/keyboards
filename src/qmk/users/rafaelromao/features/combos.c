...
combo_t key_combos[] = {
    ...
    COMBO(l_rom_ful_combo, MC_FULL),   COMBO(l_rom_del_combo, KC_DEL),   COMBO(l_rom_q_combo, KC_Q),
    COMBO(l_rom_k_combo, KC_K),        COMBO(l_rom_num_combo, TG_NUMC),  COMBO(l_rom_sav_combo, MC_SAVE),
    COMBO(l_rom_und_combo, MC_UNDO),   COMBO(l_rom_v_combo, KC_V),       COMBO(l_rom_w_combo, KC_W),
    ...
    COMBO(r_acc_excl_combo, MC_EXLM),  COMBO(r_acc_min_combo, KC_MINS),  COMBO(r_acc_oe_combo, MC_OE),
    COMBO(r_low_ent_combo, KC_ENT),    COMBO(r_low_sco_combo, TD_SCLE),  COMBO(r_med_ent_combo, TD_EENT),
    COMBO(r_med_vis_combo, KC_V),      COMBO(r_med_svi_combo, MC_SVI),   COMBO(r_med_cvi_combo, MC_CVI),
    ...
    COMBO(r_rom_npd_combo, TG_NUM),    COMBO(r_rom_j_combo, KC_J),       COMBO(r_rom_pas_combo, MC_PAST),
    COMBO(r_rom_sal_combo, MC_SELC),   COMBO(r_rom_sco_combo, TD_SCLE),  COMBO(r_rom_scp_combo, MC_SCOP),
    COMBO(r_rom_sent_combo, MC_SENT),  COMBO(r_rom_spa_combo, MC_SPAS),  COMBO(l_rom_tab_combo, KC_TAB),
    COMBO(r_rom_tab_combo, KC_TAB),    COMBO(l_acc_ent_combo, KC_ENT),   COMBO(r_acc_ent_combo, KC_ENT),
    COMBO(l_acc_tab_combo, KC_TAB),    COMBO(r_acc_tab_combo, KC_TAB),   COMBO(r_rom_z_combo, KC_Z),
