...
const uint16_t PROGMEM r_ng_the_combo[]  = {MC_TH, MC_CH, COMBO_END};
const uint16_t PROGMEM r_ng_ion_combo[]  = {MC_GH, MC_NH, COMBO_END};
...
const uint16_t PROGMEM r_ng_che_combo[]  = {MC_CH, MC_WH, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    COMBO(secret_1_combo, MC_SECRET_1), COMBO(l_num_esc_combo, KC_ESC),  COMBO(l_num_sav_combo, MC_SAVE),
    COMBO(r_num_ent_combo, KC_ENT),     COMBO(l_low_par_combo, TD_PARN), COMBO(r_low_tab_combo, KC_TAB),
    COMBO(r_low_ent_combo, KC_ENT),     COMBO(r_ng_the_combo, MC_THE),   COMBO(r_ng_ion_combo, MC_ION),
    COMBO(r_ng_ao_combo, MC_AO),        COMBO(r_ng_cao_combo, MC_CAO),   COMBO(r_ng_oes_combo, MC_OES),
    COMBO(r_ng_coes_combo, MC_COES),    COMBO(r_ng_em_combo, MC_EM),     COMBO(r_ng_che_combo, MC_CHE),
    ...
    COMBO(r_rom_ful_combo, MC_FULL),    COMBO(rom_reset_combo, RESET),
};