...
const uint16_t PROGMEM l_med_a1_combo[]  = {KC_ESC, OM_BTN1, COMBO_END};
...
combo_t key_combos[] = {
    COMBO(l_med_a1_combo, TO_A1),       COMBO(l_low_sqo_combo, MC_SQUO),  COMBO(l_low_bti_combo, MC_BTIC),
    COMBO(r_low_sfg_combo, LSFT(KC_L)), COMBO(l_low_bsl_combo, KC_BSLS),  COMBO(r_low_sent_combo, MC_SENT),
    ...
    COMBO(l_nav_esc_combo, MC_ESCC),    COMBO(l_num_ent_combo, KC_ENT),   COMBO(l_num_num_combo, TO_A1),
