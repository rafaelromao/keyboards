...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(r_ng_coes_combo, MC_COES), COMBO(r_mac_ref_combo, MC_REF),     COMBO(r_rom_cop_combo, MC_COPY),
    COMBO(r_rom_sco_combo, TD_SCLE), COMBO(l_rom_usc_combo, MC_UNDS),    COMBO(l_rom_sal_combo, MC_SELC),
    ...
    COMBO(r_rom_fin_combo, MC_FIND), COMBO(r_rom_sce_combo, MC_SENT),    COMBO(l_rom_und_combo, MC_UNDO),
