...
combo_t key_combos[] = {
    ...
    COMBO(l_sym_bsl_combo, KC_BSLS),    COMBO(r_sym_cir_combo, KC_CIRC),  COMBO(r_sym_amp_combo, KC_AMPR),
    COMBO(r_sym_pip_combo, KC_PIPE),    COMBO(r_sym_dol_combo, KC_DLR),   COMBO(r_sym_til_combo, KC_TILD),
    COMBO(r_sym_eur_combo, MC_EUR),     COMBO(r_sym_bsp_combo, KC_BSPC),  COMBO(r_low_com_combo, KC_COMM),
    ...
    COMBO(r_rai_bsp_combo, KC_BSPC),    COMBO(r_rai_deq_combo, MC_DEQ),   COMBO(r_rai_til_combo, TD_TIL),
    COMBO(r_rai_dor_combo, TD_DOR),     COMBO(r_rai_tisl_combo, MC_TISL), COMBO(r_rai_dds_combo, MC_DDS),
    COMBO(r_rai_neq_combo, MC_NEQ),     COMBO(r_rai_dan_combo, TD_DAND),  COMBO(r_rai_cir_combo, TD_CIRC),
