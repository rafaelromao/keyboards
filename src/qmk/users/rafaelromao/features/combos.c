...
combo_t key_combos[] = {
    ...
    COMBO(l_rom_ful_combo, MC_FULL),  COMBO(r_rom_pas_combo, MC_PAST),   COMBO(r_nav_pas_combo, MC_PAST),
    COMBO(r_rom_spa_combo, MC_SPAS),  COMBO(l_rom_sav_combo, MC_SAVE),   COMBO(l_rom_esc_combo, MC_ESCC),
    COMBO(l_rom_und_combo, MC_UNDO),  COMBO(l_rom_fin_combo, MC_FIND),   COMBO(r_rom_bsp_combo, KC_BSPC),
